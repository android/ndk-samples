...
class NativeCamera {
  private:
    ...
    ACaptureSessionOutput *output_, *jpgOutput_;
    ACameraCaptureSession_stateCallbacks sessionListener_;
    ACameraCaptureSession* captureSession_;
    CaptureSessionState captureSessionState_;
    ACaptureRequest *captureRequest_, *jpgRequest_;
    ACameraOutputTarget *outputTarget_, *jpgTarget_;

    ANativeWindow *outputWindow_, *jpgNativeWindow_;
    int jpgCaptureSequenceId_;
  ...
  public:
    ...
    bool FindSupportedCaptureResolution(ANativeWindow *display,
                                        ImageResolution* view,
                                        ImageResolution* capture);
